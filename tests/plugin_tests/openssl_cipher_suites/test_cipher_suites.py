...
from sslyze.plugins.openssl_cipher_suites.cipher_suites import _SSLV2_OPENSSL_TO_RFC_NAMES_MAPPING, \
    _RFC_NAME_TO_KEY_SIZE_MAPPING, _TLS_OPENSSL_TO_RFC_NAMES_MAPPING
